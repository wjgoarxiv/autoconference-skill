"""Generate performance visualization for the sorting optimization conference."""
...
def load_conference_results(tsv_path):
    ...
    with open(tsv_path, "r") as f:
        ...
        for row in reader:
            ...
            # Use sequential index as global iteration counter
...
def main():
    ...
    # Target line
    ax.axhline(y=0.5, color="#DC2626", linestyle="--", linewidth=1.2, alpha=0.7, label="Target (< 0.5s)")

    ax.set_xlabel("Iteration")
    ax.set_ylabel("Execution Time (s)")
    ax.set_title("Sorting Optimization")

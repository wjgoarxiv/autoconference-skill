"""Generate visualization for the literature review conference."""
...
def main():
    ...
    # Target line
    ax.axhline(y=8, color="#DC2626", linestyle="--", linewidth=1.2, alpha=0.7, label="Target (8/8)")

    ax.set_xlabel("Iteration")
    ax.set_ylabel("Categories Covered")
    ax.set_title("Literature Review Coverage")
